    ...
    <>
        ...
        {newest ? (
          <div className="hl">
            ...
            <span className="hl__text">
              <a href={newest.url} target="_blank" rel="noreferrer"><strong>{newest.brand}</strong></a> ({newest.generic}) — {newest.manufacturer}
      ...
      <section className="glance" aria-label="Landscape summary">
        <div className="glance__item">
          ...
          <div className="glance__value"><CountUp value={trialTotal} /></div>
        ...
        <div className="glance__item">
          ...
          <div className="glance__value"><CountUp value={therapies.items.length} /></div>
        ...
        <div className="glance__item">
          ...
          <div className="glance__value"><CountUp value={pubTotal} /></div>
        ...
        <div className="glance__item">
          ...
          <div className="glance__value"><CountUp value={news.items.length} /></div>
        ...
        <Reveal>
          <section className="section">
            <div className="section__head">
              <div>
                <p className="section__eyebrow">Interactive</p>
                <h2 className="section__title">{area.model.title}</h2>
              </div>
            </div>
            <DiseaseModel model={area.model} accent={area.accent} />
          </section>
        </Reveal>
      ) : null}
      ...
      <RegulatoryRisk area={area} variant="compact" />
    </>
  );
}
