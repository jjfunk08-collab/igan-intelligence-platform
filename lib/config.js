...
export const INDICATIONS = {
  ...
  "obesity": {
    ...
    market: {
      valueNow: "$13.84B",
      valueNowLabel: "Global GLP-1 obesity market, 2024",
      valueProjected: "$48.84B",
      valueProjectedYear: "2030E",
      valueSource: "Grand View Research",
      stats: [
        { value: "~$400B", label: "Incremental US semaglutide + tirzepatide revenue, 2025–2030E", source: "industry analysis" },
        { value: "$1T+", label: "Eli Lilly market cap — first pharma company to cross $1 trillion", source: "public markets" },
        { value: "56% vs 19%", label: "New scripts with vs without a diabetes diagnosis (Ozempic/Mounjaro vs Wegovy)", source: "Trilliant Health" },
      ],
      populations: [
        { value: "~100M+", label: "US adults with obesity (BMI ≥30) — most undiagnosed or untreated", source: "CDC (41.9% prevalence)" },
        { value: "~10–15M", label: "On anti-obesity GLP-1 medication today (est.)", source: "FAIR Health / industry" },
        { value: "~25–30M", label: "Projected on GLP-1 treatment by 2030E", source: "J.P. Morgan Research" },
      ],
      salesYear: "2025",
      salesNote: "Reported or estimated annual net sales; top products by revenue.",
      topSales: [
        { drug: "Zepbound / Mounjaro", maker: "Eli Lilly", value: 36.5, display: "$36.5B", note: "Combined tirzepatide" },
        { drug: "Wegovy / Ozempic", maker: "Novo Nordisk", value: 32, display: "$32B", note: "Combined semaglutide" },
        { drug: "Trulicity", maker: "Eli Lilly", value: 5, display: "$5B", note: "Dulaglutide (est.)" },
        { drug: "Saxenda", maker: "Novo Nordisk", value: 1.5, display: "~$1.5B", note: "Liraglutide (est.)" },
        { drug: "Contrave", maker: "Currax", value: 0.3, display: "~$0.3B", note: "Naltrexone/bupropion (est.)" },
      ],
      sourceNote: "Market sizing and sales are curated from public company reports and market-research summaries; population figures are estimates from cited public sources (CDC, FAIR Health, sell-side research). Directional context, not a substitute for primary sources.",
    },
    model: {
      type: "metabolic",
...
export const SOURCES = {
  ...
  crl: {
    name: "Complete Response Letters (openFDA)", attribution: "U.S. Food and Drug Administration",
    home: "https://open.fda.gov/apis/transparency/completeresponseletters", api: "https://api.fda.gov/transparency/crl.json",
    terms: "https://open.fda.gov/terms/",
    cadence: "As issued at source; refreshed here daily", auth: "Optional API key",
  },
};
