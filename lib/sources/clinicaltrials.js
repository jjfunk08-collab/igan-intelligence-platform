...
export async function getClinicalTrials(limit = 60) {
  ...
  // Note: results are re-sorted client-side by last-update date below, so we
  // avoid passing a server sort token (its exact syntax varies by API build).
